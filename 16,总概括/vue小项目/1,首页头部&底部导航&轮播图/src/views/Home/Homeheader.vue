...
export default {
  ...
  data() {
    return {
      selectedIndex: [],
      // 只有data中的数据才会显示到抽屉中，作为计算属性获取
    };
  },
  computed:{
    data(){
      let allActive = [{text:"全部电影",value:-1}]
      // [{"text":"动作片","value":0},{"text":"剧情片","value":1},{"text":"其他","value":2}]
      // 数据就是由[]层层包着的，当存在数据时渲染，否则只有总的标题
  ...
  methods: {
    ...
    selectHandler(selectedVal, selectedIndex, selectedText) {
      // console.log(selectedVal)//它是value的值  [-1, __ob__: Observer]
